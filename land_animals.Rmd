...
plot_ly(data = anim, x = ~animal, y = ~ratio, color = ~animal, type = 'bar') %>%  layout(showlegend = FALSE)
```

### The ratios are calculated on the model of the no dino subgroup, because that model gave the best fit.
